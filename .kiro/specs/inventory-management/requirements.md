...
2. THE Inventory_Management_Module SHALL implementar endpoints: POST /inventory/categories, GET /inventory/categories, PUT /inventory/categories/{id}, DELETE /inventory/categories/{id}, POST /inventory/supplies, GET /inventory/supplies, GET /inventory/supplies/{id}, PUT /inventory/supplies/{id}, DELETE /inventory/supplies/{id}, POST /inventory/movements, GET /inventory/movements, GET /inventory/supplies/{id}/movements, GET /inventory/alerts/stock, GET /inventory/alerts/expiration, GET /reports/inventory-valuation, GET /reports/supply-consumption, GET /reports/consumption-costs, GET /inventory/units
